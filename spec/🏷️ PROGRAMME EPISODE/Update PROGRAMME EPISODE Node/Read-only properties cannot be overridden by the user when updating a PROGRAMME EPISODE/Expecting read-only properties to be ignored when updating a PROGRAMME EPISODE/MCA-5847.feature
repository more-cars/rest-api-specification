...
Feature: Update PROGRAMME EPISODE Node
  ...
  @RULE_MCA-5846
  Rule: Read-only properties cannot be overridden by the user when updating a PROGRAMME EPISODE

    @TEST_MCA-5847 @implemented
    Scenario: Expecting read-only properties to be ignored when updating a PROGRAMME EPISODE
