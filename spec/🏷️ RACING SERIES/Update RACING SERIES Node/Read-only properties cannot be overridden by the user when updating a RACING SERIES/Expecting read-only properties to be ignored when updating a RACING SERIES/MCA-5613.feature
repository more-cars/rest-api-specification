...
Feature: Update RACING SERIES Node
  ...
  @RULE_MCA-5612
  Rule: Read-only properties cannot be overridden by the user when updating a RACING SERIES

    @TEST_MCA-5613 @implemented
    Scenario: Expecting read-only properties to be ignored when updating a RACING SERIES
