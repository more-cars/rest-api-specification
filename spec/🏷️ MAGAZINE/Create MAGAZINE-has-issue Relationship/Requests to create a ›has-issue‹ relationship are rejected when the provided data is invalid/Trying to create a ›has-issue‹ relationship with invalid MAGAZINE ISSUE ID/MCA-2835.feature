...
Feature: Create MAGAZINE-has-issue Relationship
  ...
  Rule: Requests to create a ›has-issue‹ relationship are rejected when the provided data is invalid
    ...
    @TEST_MCA-2835 @implemented
    Scenario: Trying to create a ›has-issue‹ relationship with invalid MAGAZINE ISSUE ID
      Given there exists a "MAGAZINE" "Top Gear"
      And "MAGAZINE ISSUE" "Best Sportscars 2015" does NOT exist
