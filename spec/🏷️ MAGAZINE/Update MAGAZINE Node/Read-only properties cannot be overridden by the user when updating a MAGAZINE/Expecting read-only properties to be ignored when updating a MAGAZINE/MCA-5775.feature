...
Feature: Update MAGAZINE Node
  ...
  @RULE_MCA-5774
  Rule: Read-only properties cannot be overridden by the user when updating a MAGAZINE

    @TEST_MCA-5775 @implemented
    Scenario: Expecting read-only properties to be ignored when updating a MAGAZINE
