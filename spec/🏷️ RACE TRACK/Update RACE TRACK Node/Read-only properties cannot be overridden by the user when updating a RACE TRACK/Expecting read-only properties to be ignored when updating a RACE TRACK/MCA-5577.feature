...
Feature: Update RACE TRACK Node
  ...
  @RULE_MCA-5576
  Rule: Read-only properties cannot be overridden by the user when updating a RACE TRACK

    @TEST_MCA-5577 @implemented
    Scenario: Expecting read-only properties to be ignored when updating a RACE TRACK
