...
Feature: Delete CAR MODEL VARIANT-presented-in-programme-episode Relationship
  ...
  @RULE_MCA-3779
  Rule: Requests to delete the ›presented-in-programme-episode‹ relationship are rejected when the relationship does not exist

    @TEST_MCA-3780
    Scenario: Trying to delete a non-existent ›presented-in-programme-episode‹ relationship
      Given there exists a "CAR MODEL VARIANT" "McLaren P1"
      And there exists a "PROGRAMME EPISODE" "Funeral for a Ford"
      And there exists NO "presented in programme episode" relationship between "McLaren P1" and "Funeral for a Ford"
