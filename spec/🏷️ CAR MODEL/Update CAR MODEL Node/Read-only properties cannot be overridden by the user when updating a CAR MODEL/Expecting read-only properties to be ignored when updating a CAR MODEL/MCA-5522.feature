...
Feature: Update CAR MODEL Node
  ...
  @RULE_MCA-5521
  Rule: Read-only properties cannot be overridden by the user when updating a CAR MODEL

    @TEST_MCA-5522 @implemented
    Scenario: Expecting read-only properties to be ignored when updating a CAR MODEL
